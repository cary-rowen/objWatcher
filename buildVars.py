...
addon_info = AddonInfo(
	...
	addon_changelog=_("""Compatible with NVDA2025.1"""),
	# Author(s)
	...
	addon_sourceURL="https://github.com/cary-rowen/objWatcher",
...
pythonSources: list[str] = ["addon/globalPlugins/objWatcher/*.py"]
